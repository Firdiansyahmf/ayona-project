...
def menuUtama():
    console.print(Panel("Menu Utama", style="bold bright_cyan", width=14))
    console.print("[bold bright_white]1. Yo-Managements[/bold bright_white]")
    console.print("[bold bright_white]2. Perhitungan Tabungan[/bold bright_white]")
    console.print("[bold bright_white]3. Bantuan Pengguna[/bold bright_white]")
    console.print("[bold bright_yellow]4. Keluar dari aplikasi[/bold bright_yellow]")
    pilihan = Prompt.ask("[bold bright_cyan]Pilih menu yang ingin Anda akses (1-3), atau pilih 4 untuk keluar[/bold bright_cyan]", choices=["1", "2", "3", "4"])
    return pilihan
